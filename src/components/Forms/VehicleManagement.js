...
const VehicleManagement = () => {
    ...
    const onSubmit = data => {
        const details = {
            ticketCategory: 'Vehicle Management',
            ...
            <div className="row mt-3">
                ...
                <h2 className='ticket-modal-body-title ps-1'>Person Assign</h2>
                    ...
                    <div className="mt-3">
                        ...
                        <input id='vehicle-management-due-date' value={selectedDate} onChange={(e) => setSelectedDate(e.target.value)} type="date" name="" min={new Date().toISOString().split('T')[0]} required />
                        <br />
